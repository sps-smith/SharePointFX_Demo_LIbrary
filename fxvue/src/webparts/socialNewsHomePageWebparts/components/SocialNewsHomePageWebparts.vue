<template>
    <div :class="$style.SocialNewsHomePageWebparts">
 ...
 */
export interface ISocialNewsHomePageWebpartsProps {
    description: string;
}
...
export default class SocialNewsHomePageWebparts extends Vue implements ISocialNewsHomePageWebpartsProps {
